...
impl<
		...
		Criterion: for<'a> Convert<&'a AssetKind, Either<Left::AssetId, Right::AssetId>>,
		AssetKind: AssetId,
		AccountId,
...
impl<
		...
		LeftAssetId,
		RightAssetId,
		Criterion: for<'a> Convert<&'a AssetKind, Either<LeftAssetId, RightAssetId>>,
		AssetKind,
		Balance,
		AccountId,
